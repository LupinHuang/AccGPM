...
v++ -g -t hw_emu --platform xilinx_u55c_gen3x16_xdma_3_202210_1 -c -k subgraph_kernel_plan5_v1 -I./src -o ./hw_emu_1/test1.xo ./src/testSIU_v7_gemini_1.cpp
#--config ./sw_emu/hls_config.cfg
# ----------------------------------------------------
# 阶段三：链接生成用于软件仿真的 xclbin 文件
# ----------------------------------------------------
v++ -g -t hw_emu --platform xilinx_u55c_gen3x16_xdma_3_202210_1 -l ./hw_emu_1/test1.xo --config ./src/u55C_v6_gemini_1.cfg  -o ./hw_emu_1/testSIU_hw_emu.xclbin

export XCL_EMULATION_MODE=hw_emu

./host/host_v13_gemini_for_burst_1.exe \
 ./hw_emu_1/testSIU_hw_emu.xclbin \
  ./Dataset/citeseer.txt > hw_emu_citeseer1.txt